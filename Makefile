...
#    Updated: 2018/09/25 16:50:32 by jmarquet    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
LIB_NAME = ft
PATH = ./
SRCS = $(addprefix $(PATH), main.c allocators.c helpers.c destructors.c expansions.c expansions_utilities.c parser.c dispatcher.c exec.c)
