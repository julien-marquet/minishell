...
#    Updated: 2018/09/20 22:02:08 by jmarquet    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
LIB_NAME = ft
PATH = ./
SRCS = $(addprefix $(PATH), main.c allocators.c helpers.c destructors.c expansions.c expansions_utilities.c parser.c)
